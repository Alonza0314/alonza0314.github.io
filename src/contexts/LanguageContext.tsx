...
const translations: Record<Language, Record<string, string>> = {
  zh: {
    ...
    'education.period.isia': '2024 - 2026/02',
    ...
    'experience.item.1': 'Saviah禾薪科技 - 軟體工程師',
    'experience.item.2': 'Saviah禾薪科技 - 實習生',
    'experience.item.3': 'free5GC - Committer',
    'experience.item.4': '中央研究院資訊科技創新研究中心 - 兼任研究助理',
    'experience.item.5': '國立陽明交通大學 資訊學院 網路工程研究所 - 密碼工程課程助教',
    'experience.item.6': '國立陽明交通大學 資訊學院 網路工程研究所 - 開源核心網路設計與實作課程助教',
    'experience.item.7': '國立陽明交通大學 資訊學院多媒體工程研究所 - 創業實務課程助教',
    'experience.item.8': '國立陽明交通大學 資訊工程學系系學會 - 13級活動長',
    'experience.item.9': '國立陽明交通大學 資訊工程學系營隊 - 系露營機動 / 迎新宿營機動 / 火棍負責人',
    'experience.item.10': '國立陽明交通大學 嘉義雲林校友會 - 13級會長',
  ...
  en: {
    ...
    'experience.item.1': 'Saviah Technology - Software Engineer',
    'experience.item.2': 'Saviah Technology - Intern',
    'experience.item.3': 'free5GC - Committer',
    'experience.item.4': 'Academia Sinica - Research Center for Information Technology Innovation - Part-time Research Assistant',
    'experience.item.5': 'National Yang Ming Chiao Tung University - Institute of Network Engineering - Teaching Assistant for Cryptographic Engineering',
    'experience.item.6': 'National Yang Ming Chiao Tung University - Institute of Network Engineering - Teaching Assistant for Open Source Core Network Design and Implementation',
    'experience.item.7': 'National Yang Ming Chiao Tung University - Institute of Multimedia Engineering - Teaching Assistant for Entrepreneurship Practice',
    'experience.item.8': 'National Yang Ming Chiao Tung University - Computer Science Student Association - Activity Director (Class of 13)',
    'experience.item.9': 'National Yang Ming Chiao Tung University - Computer Science Department Camp - Camp Coordinator / Fire Stick Leader',
    'experience.item.10': 'National Yang Ming Chiao Tung University - Chiayi and Yunlin Alumni Association - President (Class of 13)',
